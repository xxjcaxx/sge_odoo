...
Com a usuari `sudoer` en el vostre VPS, heu de configurar el sistema per a poder executar comandaments de Docker sense escriure `sudo` cada vegada. Afegeix el teu usuari al grup `docker`.

#### 2. Instal·lació de Docker Compose
Heu d'instal·lar Docker Compose si no està disponible a la vostra imatge de VPS.
...
*   Ves a la configuració de l'usuari administrador, a la pestanya de seguretat, i genera una **API Key**.
---
